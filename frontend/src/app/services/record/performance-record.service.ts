...
export class PerformanceRecordService {
  ...
  addPerformanceRecord(performanceRecord: PerformanceRecord): Observable<ArrayBuffer> {
  ...
  getAllPerformanceRecords(): Observable<PerformanceRecord[]> {
    return this.http.get<PerformanceRecord[]>(environment.apiEndpoint + "/api/performancerecord", {
